...
git init
git add .
git commit -m "Release DCS RadioForge 0.1.1"
git branch -M main
...
```powershell
gh release create v0.1.1 ..\dcs-radioforge-v0.1.1-source.zip ..\DCS-RadioForge-v0.1.1-windows-portable.zip --title "DCS RadioForge 0.1.1" --notes-file RELEASE_NOTES.md
```
